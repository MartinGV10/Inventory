...
const SQL = `
  -- Optional: reset tables so IDs are predictable (comment out if you don't want)
  -- TRUNCATE transfers, listings, player_club_contracts, player_positions, players, clubs, positions
